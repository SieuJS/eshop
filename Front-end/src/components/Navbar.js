    ...
    return (
        <div className="bg-light container-fluid mb-5 sticky-top border-bottom">
            <div className="row border-top px-xl-5">
                ...
                <div className="m-2">
                    <button className="btn shadow-none d-flex align-items-center justify-content-between bg-primary text-white w-100 gap-2"
                        style={{ height: "65px", marginTop: "-1px", padding: "0 30px" }}
                        onClick={toggleCat}
                    >
                        <h6 className="m-0">Categories</h6>
                ...
                <div className="col-lg-3">
                    <div className="navbar-nav ml-auto py-0">
                        {!auth.isLoggedIn && (
                            <div className="text-right w-100 py-3 px-0">
                                <NavLink to="/login" className="nav-item">Login/Register</NavLink>
                            </div>
                        )}
                        {auth.isLoggedIn &&
                            (<div>
