...
import { SIGN_IN_API as apiSignin, SIGN_UP_API as apiSignup} from '../keys/BackEndKeys'
    ...
    const authSubmitHandler = async (event) => {
      ...
      if (isLoginMode) {
        ...
        try {
          ...
          FormDataEvent.append("role", formState.inputs.role.value);
            ...
            <>
              <Input
                ...
                validators={[
                  ...
                  VALIDATOR_COMPARE_STR(formState.inputs.password.value),
                ]}
                errorText={{
                  REQUIRE: "Ô này không được để trống",
                  MINLENGTH: `Mật khẩu phải có độ dài lớn hơn ${6}`,
